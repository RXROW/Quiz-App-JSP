...
const Groups = () => {
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        const response = await privateInstance.get(STUDENT.GET_ALL_WITHOUT_GROUP);
      ...
      <div className="max-w-5xl mx-auto bg-white rounded-lg shadow p-6 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {groups.map((group, index) => (
            <div key={index} className="bg-white border border-gray-300 rounded-lg p-4 flex justify-between items-center shadow-sm">
              <div>
